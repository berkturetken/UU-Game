...
import time
import random
import game_f as game
import game as game_c
import peer
...
def server_side_tournament():
    ...
    while True:
        ...
        if end == 1:
            ...
            while True:
                if (not human_dict[players[0]]):
                    winner = game_c.playOnlineAI(True, c, players[0], players[1])                    
                else:
                    winner = game_c.playOnlineVersusTournament(True, c, players[0], players[1])
    ...
    while True:
        ...
        if data["instruction"] == "COMPLETE":
            ...
            while True:
                ...
                if (not human_dict[players[1]]):
                    winner = game_c.playOnlineAI(False, c, players[1], players[0])                    
                else:
                    winner = game_c.playOnlineVersusTournament(False, c, players[1], players[0])
